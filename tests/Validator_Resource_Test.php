...
class Validator_Resource_Test extends \PHPUnit\Framework\TestCase
{
    public function test()
    {
        $this->Validator = new Resource_Message_Validator();
    ...
    private resource_Message_Validator $Validator;
}
